SamacSys ECAD Model
411482/1510648/2.50/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "MC100EP140DG" (originalName "MC100EP140DG")
	...
	(compDef "MC100EP140DG" (originalName "MC100EP140DG") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "__U") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "2" (pinName "U") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "3" (pinName "__D") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(compPin "7" (pinName "R") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "6" (pinName "FB") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "5" (pinName "VEE") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "MC100EP140DG"))
		...
		(attr "Mouser Part Number" "863-MC100EP140DG")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/onsemi/MC100EP140DG?qs=zorda86t5M%2F2z7ITANN%252BMg%3D%3D")
		(attr "Manufacturer_Name" "onsemi")
		(attr "Manufacturer_Part_Number" "MC100EP140DG")
		(attr "Description" "MC100EP140DG, Phase Frequency Detector 2.1GHz 5 8-Pin SOIC")
		(attr "Datasheet Link" "https://componentsearchengine.com/Datasheets/2/MC100EP140DG.pdf")
		(attr "Height" "1.75 mm")
	)
